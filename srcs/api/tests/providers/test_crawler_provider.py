...
from app.domain.crawlers import CrawlerLatestChapterResponse, CrawlerMetadataResponse
...
def test_validate_novel543_url_canonicalizes_trailing_slash() -> None:
    source = validate_crawler_source("novel543", "https://www.novel543.com/0603625457")

    assert source.crawler_id == "novel543"
    assert source.source_novel_id == "0603625457"
    assert source.source_url == "https://www.novel543.com/0603625457/"
    assert source.canonical_url == "https://www.novel543.com/0603625457/"
...
def test_crawler_metadata_response_uses_camel_case_aliases() -> None:
    ...
    assert payload["sourceUrl"] == "https://www.novel543.com/0603625457/"
    assert payload["sourceNovelId"] == "0603625457"
    assert payload["latestChapters"][0]["chapterNumber"] == 536
